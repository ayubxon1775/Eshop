      ...
      <div className="container">
        <div className="grid md:grid-cols-3 pb-20 pt-5">
          ...
          <a href="#"
            ...
            <p className='text-gray-600 dark:text-white/70 lg:pr-24 pt-3'>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Sapiente, perferendis?</p>
              ...
              <ul className='space-y-3'>
                ...
                <div className='py-8 px-4 col-span-2 sm:col-auto'>
                  ...
                  <div className="flex items-center gap-3">
                    <FaLocationArrow/>
                    <p>Namangan, Namangan shahar</p>
                    
                  </div>
                  <div className='flex items-center gap-3 mt-6'>
                    <FaMobileAlt/>
                    <p>+998 99 441 17 75</p>
                  </div>
                  {/* social kinks */}
                  <div className='flex items-center gap-3 mt-6'>
